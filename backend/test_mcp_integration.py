...
class TestMCPURLFetchAgentWithGemini(unittest.TestCase):
    ...
    @patch('mcp_url_fetch_agent.MCPApp')
    @patch('mcp_url_fetch_agent.Agent')
            ...
            async with self.mock_app.run() as agent_app:
                ...
                async with finder_agent:
                    ...
                    result = await llm.generate_str(
                        ...
                        request_params=mcp_url_fetch_agent.RequestParams(
                            modelPreferences=mcp_url_fetch_agent.ModelPreferences(
