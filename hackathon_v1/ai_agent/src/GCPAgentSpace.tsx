...
- Priority: ${incident.priority}`;
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#333', color: '#fff' }}>
      {/* Sidebar */}
      <div style={{ width: '64px', backgroundColor: '#333', padding: '10px' }}>
      ...
      <div style={{ width: '256px', backgroundColor: '#444', overflowY: 'auto', borderRight: '1px solid #555' }}>
        <div style={{ padding: '16px', borderBottom: '1px solid #555', borderRadius: '8px', backgroundColor: '#555',  }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', cursor: 'pointer' }} onClick={() => setIsIncidentMenuOpen(!isIncidentMenuOpen)}>
            <h2 style={{
              fontWeight: 'bold', fontSize: '18px', width: '100%',     
              textAlign: 'center' }}>Incidents</h2>
        ...
        {/* Agents Panel */}
        <div style={{ padding: '16px', borderTop: '1px solid #555', marginTop: '16px', borderRadius: '8px' }}>
          <div style={{ backgroundColor: '#555', padding: '8px 16px', fontWeight: 'bold', borderBottom: '1px solid #666', textAlign: 'center' }}>
            Pick an Agent
          </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{
          height: '35px',
          backgroundColor: '#d71e2b', // Wells Fargo red
          borderBottom: '4px solid #ffb600', // Wells Fargo yellow
          display: 'flex',
          alignItems: 'center',
          ...
          <span style={{
            fontFamily: 'Wells Fargo Sans, Arial, sans-serif',
            fontSize: '16px',
            fontWeight: 'bold',
            color: '#fff'
          }}>
        ...
        <div style={{ height: '56px', backgroundColor: '#444', borderBottom: '1px solid #555', display: 'flex', alignItems: 'center', padding: '0 24px', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h1 style={{ fontSize: '24px', color: '#fff', fontWeight: 'bold' }}>
